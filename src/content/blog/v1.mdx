---
title: MDX goes stable
---

<Note type="legacy">
  **Note**: This is an old blog post. [ZEIT is now Vercel](https://rauchg.com/2020/vercel). An “`@mdx` pragma” is no
  longer needed. The below is kept as is for historical purposes.
</Note>
...
_[remark](https://github.com/remarkjs/remark) plugin_.
That sounds a bit meta.
What it means is that before we had the syntax parsing bits _in_ the library
