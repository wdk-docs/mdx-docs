...
<Note type="legacy">
  **Note**: This is an old blog post. The features described in it are currently documented at [§ MDX
  provider](/docs/using-mdx/#mdx-provider). The below is kept as is for historical purposes.
</Note>
