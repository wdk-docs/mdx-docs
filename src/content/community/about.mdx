...
Markdown _does_ have a way to extend it, HTML, but that has drawbacks:
...
<Note type="info">**Note**: Is your work missing? Please open a PR if we failed to attribute your work.</Note>
