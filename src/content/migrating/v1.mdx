export const info = {
  author: [{ github: "johno", name: "John Otander", twitter: "4lpine" }],
...
<Note type="legacy">
  **Note**: This is an old migration guide. See [§ Migrating from v1 to v2](/migrating/v2/). The below is kept as is for
  historical purposes.
</Note>
...
<MDXProvider components={components}>
  <MDXProvider components={(outerComponents) => newComponents}>{children}</MDXProvider>
</MDXProvider>
```
